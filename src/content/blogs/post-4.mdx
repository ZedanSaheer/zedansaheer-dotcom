...
author: Zedan Saheer
tags: ["Life"]
image: { src: "@assets/blogs/post-4.jpg", alt: "Testing cover picture ALT tag" }
---

import { Image } from "astro:assets";
import BlogCover from "@components/blog/BlogCover.astro"
import blogCoverImage from "@assets/blogs/post-4.jpg";
...
Versato _fluit_ Othrys solis. Regis exarsit cavas, et nec quique auxilium currus
...
ipsas**; iam paene: et _valuere Eurus derexit_ hominis. Speculatur ingens fama
