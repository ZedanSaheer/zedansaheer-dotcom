...
import image_one from '@assets/blogs/post-1.00a.png';
import image_two from '@assets/blogs/post-1.00b.png';
...
<Image src={image_one} alt="How Node.js Render On Local Devices - Drawing" class="w-full"/>
...
<Image src={image_two} alt="Comparing latency for Non-Blocking - Drawing" class="w-full"/>
